...
# grid search 전 MLP 예측 정확도 실제 y_test / 예측 y_pred:  0.7533333333333333
# ------------------ Before test MLP ------------------------
# [[110  37]
#  [ 37 116]]
#               precision    recall  f1-score   support
#
#      class 0       0.75      0.75      0.75       147
...
# MLP GridSearch 최적 파라미터:  {'alpha': 0.001, 'momentum': 0.3, 'solver': 'adam'}
# MLP GridSearch 최고 점수:  0.8158333333333333

# grid-search 후 MLP test 데이터세트 정확도:  0.7533
# ------------------ After test MLP ------------------------
# [[110  37]
#  [ 37 116]]
#               precision    recall  f1-score   support

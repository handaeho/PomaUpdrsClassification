...
def poma_predict_ada(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../ada_boost_classifier/ada_boost_poma_2class_210622.pkl')
...
def updrs_predict_ada(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../ada_boost_classifier/ada_boost_updrs_2class_210622.pkl')
...
if __name__ == '__main__':
    ...
    print('AdaBoost Saved Model POMA Accuracy: {0: .4f}'.format(accuracy_score(poma_y, result_poma_predict)))

    print('------------------ Test AdaBoost POMA  ------------------------')
    ...
    print('AdaBoost Saved Model UPDRS Accuracy: {0: .4f}'.format(accuracy_score(updrs_y, result_updrs_predict)))

    print('------------------ Test AdaBoost UPDRS ------------------------')

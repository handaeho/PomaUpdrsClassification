...
def poma_predict_rf(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../random_forest/rf_poma_2class_210622.pkl')
...
def updrs_predict_rf(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../random_forest/rf_updrs_2class_210622.pkl')

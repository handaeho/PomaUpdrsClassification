...
def poma_predict_et(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../extra_trees_classifier/et_poma_2class_210622.pkl')
...
def updrs_predict_et(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../extra_trees_classifier/et_updrs_2class_210622.pkl')
...
if __name__ == '__main__':
    ...
    result_poma_predict = poma_predict_et(poma_x)

    result_updrs_predict = updrs_predict_et(updrs_x)

    print('ET Saved Model POMA Accuracy: {0: .4f}'.format(accuracy_score(poma_y, result_poma_predict)))
    ...
    print('ET Saved Model UPDRS Accuracy: {0: .4f}'.format(accuracy_score(updrs_y, result_updrs_predict)))

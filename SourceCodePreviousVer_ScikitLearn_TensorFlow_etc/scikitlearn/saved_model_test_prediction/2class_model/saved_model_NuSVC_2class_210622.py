...
def poma_predict_nusvc(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../support_vector_machine/nu_svc_poma_2class_210622.pkl')
...
def updrs_predict_nusvc(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../support_vector_machine/nu_svc_updrs_2class_210622.pkl')
...
if __name__ == '__main__':
    ...
    result_poma_predict = poma_predict_nusvc(poma_x)

    result_updrs_predict = updrs_predict_nusvc(updrs_x)

    print('NuSVC Saved Model POMA Accuracy: {0: .4f}'.format(accuracy_score(poma_y, result_poma_predict)))

    print('------------------ Test NuSVC POMA  ------------------------')
    ...
    print('NuSVC Saved Model UPDRS Accuracy: {0: .4f}'.format(accuracy_score(updrs_y, result_updrs_predict)))

    print('------------------ Test NuSVC UPDRS ------------------------')

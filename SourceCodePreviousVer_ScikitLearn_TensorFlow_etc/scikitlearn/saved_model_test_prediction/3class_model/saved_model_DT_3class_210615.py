...
def poma_predict_dt(result):
    # load saved model
    clf_from_joblib = joblib.load('../../decision_tree/dt_poma_3class_210615.pkl')
...
def updrs_predict_dt(result):
    # load saved model
    clf_from_joblib = joblib.load('../../decision_tree/dt_updrs_3class_210615.pkl')

...
def poma_predict_mlp(result):
    # load saved model
    clf_from_joblib = joblib.load('../../multi_layer_perceptron_classifier/mlp_poma_3class_210615.pkl')
...
def updrs_predict_mlp(result):
    # load saved model
    clf_from_joblib = joblib.load('../../multi_layer_perceptron_classifier/mlp_updrs_3class_210615.pkl')

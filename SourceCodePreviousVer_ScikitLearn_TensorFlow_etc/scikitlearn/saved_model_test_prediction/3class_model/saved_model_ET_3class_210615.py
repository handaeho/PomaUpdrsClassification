...
def poma_predict_et(result):
    # load saved model
    clf_from_joblib = joblib.load('../../extra_trees_classifier/et_poma_3class_210615.pkl')
...
def updrs_predict_et(result):
    # load saved model
    clf_from_joblib = joblib.load('../../extra_trees_classifier/et_updrs_3class_210615.pkl')

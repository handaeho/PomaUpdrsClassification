...
def poma_predict_nusvc(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../support_vector_machine/nu_svc_poma_3class_210615.pkl')
...
def updrs_predict_nusvc(dataset):
    # load saved model
    clf_from_joblib = joblib.load('../../support_vector_machine/nu_svc_updrs_3class_210615.pkl')

...
def poma_predict_ada(result):
    # load saved model
    clf_from_joblib = joblib.load('../../ada_boost_classifier/ada_boost_poma_3class_210615.pkl')
...
def updrs_predict_ada(result):
    # load saved model
    clf_from_joblib = joblib.load('../../ada_boost_classifier/ada_boost_updrs_3class_210615.pkl')
...
if __name__ == '__main__':
    ...
    result_poma_predict = poma_predict_ada(poma_x)

    result_updrs_predict = updrs_predict_ada(updrs_x)

    print('Ada Boost Saved Model POMA Accuracy: {0: .4f}'.format(accuracy_score(poma_y, result_poma_predict)))

    print('------------------ Test Ada Boost POMA  ------------------------')
    ...
    print('Ada Boost Saved Model UPDRS Accuracy: {0: .4f}'.format(accuracy_score(updrs_y, result_updrs_predict)))

    print('------------------ Test Ada Boost UPDRS  ------------------------')

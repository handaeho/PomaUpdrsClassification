...
# 'danger' 컬럼 pop -> 라벨
y_train_t = dftrain_t.pop('pomadanger3class0').astype(np.int32)
y_eval = dfeval.pop('pomadanger3class0').astype(np.int32)
y_test = dftest.pop('pomadanger3class0').astype(np.int32)
...
x_train_scaled = pd.DataFrame(x_train_scaled, columns=dftrain_t.columns).astype(np.float32)
x_eval_scaled = pd.DataFrame(x_eval_scaled, columns=dfeval.columns).astype(np.float32)
...
x_test_scaled = pd.DataFrame(x_test_scaled, columns=dftest.columns).astype(np.float32)
...
# ------------------ Eval Predict ------------------
# {'accuracy': 0.9068225, 'average_loss': 0.28400394, 'loss': 0.2839935, 'global_step': 3960}

# ------------------ Test Predict ------------------
#                                      logits  ...         all_classes
# 0       [2.2554462, -0.7457018, -1.5581934]  ...  [b'0', b'1', b'2']
# 1       [0.4687119, 0.20818439, -0.2860644]  ...  [b'0', b'1', b'2']
# 2        [-1.098848, -2.0508077, 1.5372353]  ...  [b'0', b'1', b'2']
# 3       [2.77232, 0.104161054, -0.13530998]  ...  [b'0', b'1', b'2']
# 4     [-0.036022615, -2.5986505, 2.0959413]  ...  [b'0', b'1', b'2']
# ...                                     ...  ...                 ...
# 3953    [2.894766, -1.1886314, -0.24109958]  ...  [b'0', b'1', b'2']
# 3954   [2.6873775, 0.3704932, -0.116700605]  ...  [b'0', b'1', b'2']
# 3955   [-1.0665325, 0.19562967, -1.7181606]  ...  [b'0', b'1', b'2']
# 3956  [-0.55282104, 3.5626147, 0.046142537]  ...  [b'0', b'1', b'2']
# 3957  [-0.10852535, -0.33295518, 2.2231014]  ...  [b'0', b'1', b'2']
#
...
#
#      class 0       0.93      0.94      0.93      1988
#      class 1       0.91      0.92      0.91      1340
#      class 2       0.92      0.84      0.88       630
#
#     accuracy                           0.92      3958
#    macro avg       0.92      0.90      0.91      3958
...
export_path = dnn_estimator.export_saved_model("new_poma_dnn_model_210531", serving_input_fn)

...
####################################################################################################################
path = "updrs_DNN_TEST_h5_to_pb_210813_00000000000000000000000000000001"
...
# Saved model load.
model = load_model('updrs_dnn_keras_ver_210818_00000000000000000000000000000001.h5')
...
# Save the model.
open("UPDRS_TEST_KERAS_TELITE_FILE_210818_00000000000000000000000000000000002.tflite", "wb").write(tflite_model)

# tensorflow.lite의 get_tensor_details 함수를 이용해서 모델 정보를 확인
interpreter = tf.lite.Interpreter(model_path="UPDRS_TEST_KERAS_TELITE_FILE_210818_00000000000000000000000000000000002.tflite")

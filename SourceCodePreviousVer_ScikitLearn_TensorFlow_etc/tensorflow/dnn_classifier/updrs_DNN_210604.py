...
model_dir = './updrs_dnn_test_210604'  # 모델을 저장할 디렉토리
model_name = 'updrs_dnn_0001'  # 모델명
...
x_train, x_test, y_train, y_test = train_test_split(updrs_dataset_3class, labels, test_size=0.2,
...
#
#      class 0       0.93      0.92      0.93      1765
#      class 1       0.90      0.91      0.91      1583
#      class 2       0.89      0.89      0.89       610
#
#     accuracy                           0.91      3958
...
#        'pomadanger3class0', 'Velocityms1', 'Cycletimes2', 'LCycletimes3',
#        'RCycletimes4', 'LStridelengthm5', 'RStridelengthm6',
#        'LStrideperminStridem7', 'RStrideperminstridem8', 'LFootvelms9',
#        'RFootvelms10', 'Lsteptimes11', 'Rsteptimes12', 'LStepperminstepm13',
#        'Rstepperminstepm14', 'LStancetimes15', 'RStancetimes16',
#        'Lswingtimes17', 'RSwingtimes18', 'DLSTtimes19', 'DLSTInitialtimes20',
#        'DLSTTerminaltimes21', 'LTotal22', 'LIn23', 'Lout24', 'Lfront25',
#        'Lback26', 'L127', 'L228', 'L329', 'L430', 'L531', 'L632', 'L733',
#        'L834', 'RTotal35', 'RIn36', 'Rout37', 'Rfront38', 'Rback39', 'R140',
#        'R241', 'R342', 'R443', 'R544', 'R645', 'R746', 'R847',
#        'L1BalanceTime48', 'L249', 'L350', 'L451', 'L552', 'L653', 'L754',
#        'L855', 'R156', 'R257', 'R358', 'R459', 'R560', 'R661', 'R762', 'R863',
#        'L11Sequence64', 'L12Sequence65', 'L2166', 'L2267', 'L3168', 'L3269',
#        'L4170', 'L4271', 'L5172', 'L5273', 'L6174', 'L6275', 'L7176', 'L7277',
#        'L8178', 'L8279', 'R1180', 'R1281', 'R2182', 'R2283', 'R3184', 'R3285',
#        'R4186', 'R4287', 'R5188', 'R5289', 'R6190', 'R6291', 'R7192', 'R7293',
#        'R8194', 'R8295'

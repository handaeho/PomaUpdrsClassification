...
NUMERIC_COLUMNS = updrs_dataset_2class.columns[1:]  # 첫번째 열인 'poma_danger_3class' 제외
...
# 0    [-0.061274774]   [0.4846861]  ...        [0, 1]  [b'0', b'1']
# 1     [-0.16511191]  [0.45881554]  ...        [0, 1]  [b'0', b'1']
# 2      [-0.1285007]  [0.46791896]  ...        [0, 1]  [b'0', b'1']
# 3    [0.0043573827]  [0.50108933]  ...        [0, 1]  [b'0', b'1']
# 4      [0.19010666]    [0.547384]  ...        [0, 1]  [b'0', b'1']
# ..              ...           ...  ...           ...           ...
# 295    [0.12229995]  [0.53053695]  ...        [0, 1]  [b'0', b'1']
# 296    [0.36708105]  [0.59075344]  ...        [0, 1]  [b'0', b'1']
# 297     [3.1562858]   [0.9591557]  ...        [0, 1]  [b'0', b'1']
# 298     [0.5702661]   [0.6388246]  ...        [0, 1]  [b'0', b'1']
# 299   [-0.14328933]  [0.46423882]  ...        [0, 1]  [b'0', b'1']
#
...
#
#      class 0       0.46      0.70      0.55       138
#      class 1       0.54      0.30      0.39       162
#
#     accuracy                           0.48       300
#    macro avg       0.50      0.50      0.47       300
# weighted avg       0.50      0.48      0.46       300

...
path = "updrs_dnn_linear_test_210607/export/serving_exporter/updrs_dnn_linear_0001/1623032179"
...
tflite_model_file = tflite_models_dir / "new_updrs_dnn_linear_model_210604_quantization_0001.tflite"
# tflite_model_file = tflite_models_dir / "new_updrs_dnn_linear_model_210604_standard_0001.tflite"
tflite_model_file.write_bytes(tflite_model)

# tensorflow.lite의 get_tensor_details 함수를 이용해서 모델 정보를 확인
interpreter = tf.lite.Interpreter(model_path="new_updrs_dnn_linear_model_210604_quantization_0001.tflite")
# interpreter = tf.lite.Interpreter(model_path="new_updrs_dnn_linear_model_210604_standard_0001.tflite")

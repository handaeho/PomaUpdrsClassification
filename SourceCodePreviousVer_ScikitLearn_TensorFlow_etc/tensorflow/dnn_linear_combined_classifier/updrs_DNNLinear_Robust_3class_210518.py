...
NUMERIC_COLUMNS = updrs_dataset_3class.columns[1:]  # 첫번째 열인 'poma_danger_3class' 제외
...
# ------------------ Eval Predict ------------------
# {'accuracy': 0.92735314, 'average_loss': 0.23204042, 'loss': 0.23198503, 'global_step': 3960}

# ------------------ Test Predict ------------------
#                                    logits  ...         all_classes
# 0       [-1.12292, 3.4205897, -3.4905834]  ...  [b'0', b'1', b'2']
# 1     [-1.5852053, 4.5785675, -3.3223934]  ...  [b'0', b'1', b'2']
# 2     [5.7654753, -0.8005196, -4.3192706]  ...  [b'0', b'1', b'2']
# 3       [-1.6963857, 5.111603, -2.188454]  ...  [b'0', b'1', b'2']
# 4       [1.7746685, 6.0054693, -6.840892]  ...  [b'0', b'1', b'2']
# ...                                   ...  ...                 ...
# 3953  [4.3302536, -2.5971956, -3.6620762]  ...  [b'0', b'1', b'2']
# 3954  [0.026432015, 4.9512243, -7.200882]  ...  [b'0', b'1', b'2']
# 3955  [-0.7490199, 6.2190886, -4.3040333]  ...  [b'0', b'1', b'2']
# 3956    [7.294061, -1.5186839, -4.201892]  ...  [b'0', b'1', b'2']
# 3957    [6.61376, -0.8160451, -2.9174101]  ...  [b'0', b'1', b'2']
#
...
#
#      class 0       0.92      0.96      0.94      1812
#      class 1       0.95      0.88      0.91      1528
#      class 2       0.91      0.95      0.93       618
#
#     accuracy                           0.93      3958
...
export_path = dnn_linear_estimator.export_saved_model("new_updrs_dnn_linear_model_210518", serving_input_fn)

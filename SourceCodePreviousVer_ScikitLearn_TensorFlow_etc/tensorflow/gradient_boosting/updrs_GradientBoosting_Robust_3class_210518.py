...
dftrain_t, dfeval = train_test_split(dftrain, test_size=0.2,
                                     stratify=dftrain['updrsdanger3class0'], shuffle=True, random_state=1220)
...
NUMERIC_COLUMNS = updrs_dataset_3class.columns[1:]  # 첫번째 열인 'poma_danger_2class' 제외
...
for feature_batch, label_batch in ds.take(1):
    ...
    # "Velocityms1" 배치:  [-0.38095238  0.88095238 -0.16666667 -0.73809524 -0.80952381 -0.04761905
    #                      0.19047619  0.5  -0.26190476  0.19047619]
    # 레이블 배치:  [2 0 0 0 1 0 0 0 1 0]
...
# ------------------ Eval Predict ------------------
# {'accuracy': 0.88629186, 'average_loss': 0.33812532, 'loss': 0.33803865, 'global_step': 19768}

# ------------------ Test Predict ------------------
#                                     logits  ...         all_classes
# 0       [2.0227025, 1.9583033, -2.1050284]  ...  [b'0', b'1', b'2']
# 1      [0.87877935, 0.4771994, -2.2787592]  ...  [b'0', b'1', b'2']
# 2      [1.1621537, 0.19769828, -1.4734169]  ...  [b'0', b'1', b'2']
# 3      [2.0854208, 0.5017172, -0.88419557]  ...  [b'0', b'1', b'2']
# 4       [1.6362207, 1.5515625, -1.3056722]  ...  [b'0', b'1', b'2']
# ...                                    ...  ...                 ...
# 3953   [-0.9558541, 0.7435753, -0.4638753]  ...  [b'0', b'1', b'2']
# 3954       [1.914175, 0.631728, -2.508771]  ...  [b'0', b'1', b'2']
# 3955   [2.2586486, -0.2534877, -0.7824899]  ...  [b'0', b'1', b'2']
# 3956  [0.25261799, 1.4231291, -0.09277068]  ...  [b'0', b'1', b'2']
# 3957  [-0.06629619, 1.8317826, -1.9476824]  ...  [b'0', b'1', b'2']
#
...
#
#      class 0       0.91      0.92      0.91      1812
#      class 1       0.88      0.88      0.88      1528
#      class 2       0.90      0.85      0.87       618
#
#     accuracy                           0.90      3958
#    macro avg       0.90      0.89      0.89      3958
...
export_path = gbt_estimator.export_saved_model("new_updrs_gradient_boosting_210518", serving_input_fn)

...
path = "updrs_gradient_boosting_test_210610/export/serving_exporter/updrs_gradient_boosting_0001/1623225575"
...
tflite_model_file = tflite_models_dir / "new_updrs_gradient_boosting_model_210610_quantization_0001.tflite"
# tflite_model_file = tflite_models_dir / "new_updrs_gradient_boosting_model_210610_standard_0001.tflite"
tflite_model_file.write_bytes(tflite_model)

# tensorflow.lite의 get_tensor_details 함수를 이용해서 모델 정보를 확인
interpreter = tf.lite.Interpreter(model_path="new_updrs_gradient_boosting_model_210610_quantization_0001.tflite")
# interpreter = tf.lite.Interpreter(model_path="new_updrs_gradient_boosting_model_210610_standard_0001.tflite")

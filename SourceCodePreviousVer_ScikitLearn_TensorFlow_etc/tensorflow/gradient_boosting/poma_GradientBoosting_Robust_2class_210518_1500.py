...
ds = make_input_fn(x_train_scaled_df, y_train, batch_size=10, shuffle=True)()
...
gbt_estimator = tf.estimator.BoostedTreesClassifier(feature_columns=feature_columns, n_trees=500,
                                                    ...
                                                    n_classes=2, learning_rate=0.01)
...
# 0     [-0.08806015]  [0.47799918]  ...        [0, 1]  [b'0', b'1']
# 1      [-0.1227385]  [0.46935385]  ...        [0, 1]  [b'0', b'1']
# 2     [0.120729916]   [0.5301459]  ...        [0, 1]  [b'0', b'1']
# 3    [-0.009160213]  [0.49770996]  ...        [0, 1]  [b'0', b'1']
# 4     [0.120289765]   [0.5300362]  ...        [0, 1]  [b'0', b'1']
# ..              ...           ...  ...           ...           ...
# 295   [0.098875605]   [0.5246988]  ...        [0, 1]  [b'0', b'1']
# 296   [-0.12736607]  [0.46820146]  ...        [0, 1]  [b'0', b'1']
# 297   [-0.12736607]  [0.46820146]  ...        [0, 1]  [b'0', b'1']
# 298   [-0.08806015]  [0.47799918]  ...        [0, 1]  [b'0', b'1']
# 299    [0.14344499]  [0.53579986]  ...        [0, 1]  [b'0', b'1']
#
...
#
#      class 0       0.52      0.54      0.53       147
#      class 1       0.54      0.52      0.53       153
#
#     accuracy                           0.53       300

...
model_dir = './updrs_gradient_boosting_test_210610/'  # 모델을 저장할 디렉토리
model_name = 'updrs_gradient_boosting_0001'  # 모델명
...
#
#      class 0       0.93      0.95      0.94      1765
#      class 1       0.92      0.90      0.91      1583

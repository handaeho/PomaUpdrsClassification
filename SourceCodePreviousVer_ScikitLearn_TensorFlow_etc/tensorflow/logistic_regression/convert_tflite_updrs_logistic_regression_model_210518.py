...
tf.lite.TFLiteConverter
    - allow_custom_ops	
        ...
        True이면 알 수없는 작업에 대한 사용자 지정 작업이 생성됩니다. 
...
path = "new_updrs_logistic_regression_model_210518/1621903787"
...
# 동적 범위 양자화
# 훈련 후 양자화의 가장 간단한 형태. 8 비트의 정밀도를 가진 부동 소수점에서 정수까지 가중치만 정적으로 양자화.
...
# Save the model.
open("new_updrs_logistic_regression_210527.tflite", "wb").write(tflite_model)

# tensorflow.lite의 get_tensor_details 함수를 이용해서 모델 정보를 확인
interpreter = tf.lite.Interpreter(model_path="new_updrs_logistic_regression_210518.tflite")

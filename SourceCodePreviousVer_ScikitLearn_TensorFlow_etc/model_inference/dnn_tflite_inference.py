...
def poma_load_dataset():
    ...
    poma_dataset_3class = poma_dataset_3class.sample(n=3)
...
def updrs_load_dataset():
    ...
    updrs_dataset_3class = updrs_dataset_3class_all.sample(n=3)
...
if __name__ == '__main__':
    ...
    poma_model_path = '../SourceCodePreviousVer_ScikitLearn_TensorFlow_etc/tensorflow/dnn_classifier/TEST_TELITE_FILE_000000000005.tflite'
    updrs_model_path = '../SourceCodePreviousVer_ScikitLearn_TensorFlow_etc/tensorflow/dnn_classifier/TEST_TELITE_FILE_000000000005.tflite'

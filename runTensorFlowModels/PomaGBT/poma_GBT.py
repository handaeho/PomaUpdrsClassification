...
model_dir = '/home/aiteam/daeho/PomaUpdrs/H5_Pb_models/GBT_PB_models/poma_GBT_PB_Model/'  # 모델을 저장할 디렉토리
model_name = 'poma_gradient_boosting_model'  # 모델명
...
class MakePomaGBTModel:
    def __init__(self):
        print('Start Train and Save GBT Model with POMA DataSet')

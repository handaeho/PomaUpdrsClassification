...
def poma_load_dataset(test_dataset):
...
def tf_lite_inference(model_path, inputs, labels):
    ...
    output_index = interpreter.get_output_details()[5]["index"]

    print(input_index)
    print(interpreter.get_input_details())
    print(output_index)
    print(interpreter.get_output_details()[5])
...
if __name__ == '__main__':
    ...
    features_scaled, labels = poma_load_dataset(df)

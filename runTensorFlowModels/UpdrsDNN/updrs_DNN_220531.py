...
class MakeUpdrsDnnModel:
    def __init__(self, dataset):
        print('Start Train and Save DNN Model with UPDRS DataSet - 2022.05.31 Ver.')
        self.dataset = dataset

        self.date_time = str(datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))

        # Save model with check-point
        self.check_point_model_path = '/home/aiteam/daeho/PomaUpdrs/checkpoint_models/DNN_checkpoint_model/updrs_DNN_checkpoint_Model/'

        # Save the entire model to a HDF5 file.
        self.h5_model_path = '/home/aiteam/daeho/PomaUpdrs/H5_Pb_models/DNN_H5_models/updrs_DNN_H5_Model/'
    ...
    def model_train_test_save(self, x_train_scaled, x_eval_scaled, x_test_scaled, y_train_encoding, y_eval_encoding, y_test_encoding, labels_test):
        ...
        check_point_model_file_name = self.check_point_model_path + f'updrs_dnn_check_point_model_{self.date_time}.h5'
        ...
        try:
            model_name = f'updrs_dnn_keras_ver_{self.date_time}_{f1}.h5'
